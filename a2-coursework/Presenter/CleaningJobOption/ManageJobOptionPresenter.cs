...
public class ManageJobOptionPresenter : BasePresenter<IManageCleaningJobOptionView>, INotifyingChildPresenter {
    public event EventHandler? DetailsChanged;

    public event EventHandler<ValidationRequestEventArgs<string>>? ValidateNameRequest;

    public ManageJobOptionPresenter(IManageCleaningJobOptionView view) : base(view) {
