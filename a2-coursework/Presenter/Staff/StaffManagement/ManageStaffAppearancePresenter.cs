...
public class ManageStaffAppearancePresenter : BasePresenter<IManageStaffAppearanceSettingsView>, INotifyingChildPresenter {
    public event EventHandler? DetailsChanged;

    public ManageStaffAppearancePresenter(IManageStaffAppearanceSettingsView view) : base(view) {
