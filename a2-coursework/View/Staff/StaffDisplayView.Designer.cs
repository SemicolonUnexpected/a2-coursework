namespace a2_coursework.View.Users {
    partial class StaffDisplayView {
        /// <summary>
        ...
        private void InitializeComponent() {
            ...
            lblUser.Font = new Font("Bahnschrift", 24F);
            lblUser.ForeColor = Color.White;
            lblUser.Location = new Point(281, 23);
            lblUser.Margin = new Padding(10);
            lblUser.Name = "lblUser";
            lblUser.Size = new Size(86, 39);
            lblUser.TabIndex = 9;
            lblUser.Text = "User";
            // 
            // topBar
