...
namespace a2_coursework.View.JobOption;
public partial class DisplayJobOptionView : Form, IDisplayView<DisplayJobOptionModel>, IChildView, IThemeable, IDisplayJobOptionView {
    ...
    public void SetFont() {
        ...
        lblJobOption.SetFontName(fontName);
    ...
    private void SetupDataBindings() {
        ...
        columnId.DataPropertyName = nameof(DisplayJobOptionModel.Id);
        columnName.DataPropertyName = nameof(DisplayJobOptionModel.Name);
        columnUnitCost.DataPropertyName = nameof(DisplayJobOptionModel.UnitCost);
        columnArchived.DataPropertyName = nameof(DisplayJobOptionModel.Archived);
    }
    ...
    public DisplayJobOptionModel? SelectedItem {
        get {
            try {
                return ((BindingList<DisplayJobOptionModel>)_bindingSource.DataSource)[dataGridView.SelectedRows[0].Index];
            }
    ...
    public void DisplayItems(BindingList<DisplayJobOptionModel> items) {
