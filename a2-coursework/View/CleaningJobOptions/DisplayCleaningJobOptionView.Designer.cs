namespace a2_coursework.View.JobOption {
    partial class DisplayCleaningJobOptionView {
        /// <summary>
        ...
        private void InitializeComponent() {
            ...
            dataGridView.Columns.AddRange(new DataGridViewColumn[] { columnId, columnName, columnUnitCost, columnArchived });
            ...
            // lblJobOption
            // 
            lblJobOption.Anchor = AnchorStyles.Top;
            lblJobOption.AutoSize = true;
            lblJobOption.Font = new Font("Bahnschrift", 24F);
            lblJobOption.ForeColor = Color.White;
            lblJobOption.Location = new Point(237, 23);
            lblJobOption.Margin = new Padding(10);
            lblJobOption.Name = "lblJobOption";
            lblJobOption.Size = new Size(184, 39);
            lblJobOption.TabIndex = 9;
            lblJobOption.Text = "Job Options";
            // 
            // topBar
            // 
            ...
            Controls.Add(topBar);
            Controls.Add(lblJobOption);
            Controls.Add(pnlData);
            FormBorderStyle = FormBorderStyle.None;
            Name = "DisplayJobOptionView";
