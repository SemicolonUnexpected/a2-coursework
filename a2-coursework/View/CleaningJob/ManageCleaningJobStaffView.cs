...
public partial class ManageCleaningJobStaffView: Form, IDisplayView<DisplayCustomerModel>, IChildView, IThemeable, IDisplayCustomerView {
    ...
    public ManageCleaningJobStaffView () {
        InitializeComponent();
    ...
    public void SetFont() {
        ...
        lblCleaningJob.SetFontName(fontName);
