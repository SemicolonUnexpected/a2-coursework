...
public partial class ManageCleaningJobOptionDetailsView: Form, IManageCleaningJobOptionDetails, IThemeable {
    public event EventHandler? AddressChanged;
    public event EventHandler? ExtraInformationChanged;

    public ManageCleaningJobOptionDetailsView() {
        InitializeComponent();
    ...
    public void SetExtraInformtionCharacterCount(int number) => lblExtraInformationCharacterLimit.Text = $"{number}/{tbExtraInformation.MaxLength}";
