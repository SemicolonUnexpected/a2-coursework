...
public class StockItem(string name, string description, int stockId, string SKU, int quantity, int lowQuantity, int highQuantity, bool archived) {
    public string Name { get; set; } = name;
    public string Description { get; set; } = description;
    public int Id { get; set; } = stockId;
